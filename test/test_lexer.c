...
void test_lexInt1() {
  ...
  EXPECT_T(objEquals(intTokSym, arrayGet_unsafe(intTok, 0)));
  EXPECT_T(objEquals(intTokVal, arrayGet_unsafe(intTok, 1)));
  Object eoiTok = queueDeq(tokenQ);
  ASSERT_NE(nullObj.a, eoiTok.a);
  Object eoiTokSym = symbolNew(T_NAMES[T_EOI]);
  EXPECT_T(objEquals(eoiTokSym, arrayGet_unsafe(eoiTok, 0)));
}
...
void test_lexInt2() {
  ...
  EXPECT_T(objEquals(intTokSym, arrayGet_unsafe(intTok1, 0)));
  EXPECT_T(objEquals(intTokVal1, arrayGet_unsafe(intTok1, 1)));

  Object intTok2 = queueDeq(tokenQ);
  ASSERT_NE(nullObj.a, intTok2.a);
  Object intTokVal2 = intNew(456);
  EXPECT_T(objEquals(intTokSym, arrayGet_unsafe(intTok2, 0)));
  EXPECT_T(objEquals(intTokVal2, arrayGet_unsafe(intTok2, 1)));
...
void test_lexReal() {
  ...
  EXPECT_T(objEquals(realTokSym, arrayGet_unsafe(realTok, 0)));
  EXPECT_T(objEquals(realTokVal, arrayGet_unsafe(realTok, 1)));
  Object eoiTok = queueDeq(tokenQ);
  ASSERT_NE(nullObj.a, eoiTok.a);
  Object eoiTokSym = symbolNew(T_NAMES[T_EOI]);
  EXPECT_T(objEquals(eoiTokSym, arrayGet_unsafe(eoiTok, 0)));
...
void test_lexIdent() {
  ...
  EXPECT_T(objEquals(identTokSym, arrayGet_unsafe(identTok, 0)));
  EXPECT_T(objEquals(identTokVal, arrayGet_unsafe(identTok, 1)));
  Object eoiTok = queueDeq(tokenQ);
  ASSERT_NE(nullObj.a, eoiTok.a);
  Object eoiTokSym = symbolNew(T_NAMES[T_EOI]);
  EXPECT_T(objEquals(eoiTokSym, arrayGet_unsafe(eoiTok, 0)));
...
void test_lexSymbol() {
  ...
  EXPECT_T(objEquals(symTokSym, arrayGet_unsafe(symTok, 0)));
  EXPECT_T(objEquals(symTokVal, arrayGet_unsafe(symTok, 1)));
  Object eoiTok = queueDeq(tokenQ);
  ASSERT_NE(nullObj.a, eoiTok.a);
  Object eoiTokSym = symbolNew(T_NAMES[T_EOI]);
  EXPECT_T(objEquals(eoiTokSym, arrayGet_unsafe(eoiTok, 0)));
...
void test_lexReserved() {
  ...
  EXPECT_T(objEquals(reservedTokSym, arrayGet_unsafe(reservedTok, 0)));
  EXPECT_T(objEquals(reservedTokVal, arrayGet_unsafe(reservedTok, 1)));
  Object eoiTok = queueDeq(tokenQ);
  ASSERT_NE(nullObj.a, eoiTok.a);
  Object eoiTokSym = symbolNew(T_NAMES[T_EOI]);
  EXPECT_T(objEquals(eoiTokSym, arrayGet_unsafe(eoiTok, 0)));
...
void test_lexString() {
  ...
  EXPECT_T(objEquals(stringTokSym, arrayGet_unsafe(stringTok, 0)));
  EXPECT_T(objEquals(stringTokVal, arrayGet_unsafe(stringTok, 1)));
  Object eoiTok = queueDeq(tokenQ);
  ASSERT_NE(nullObj.a, eoiTok.a);
  Object eoiTokSym = symbolNew(T_NAMES[T_EOI]);
  EXPECT_T(objEquals(eoiTokSym, arrayGet_unsafe(eoiTok, 0)));
...
void test_lexOper() {
  ...
  EXPECT_T(objEquals(operTokSym, arrayGet_unsafe(operTok, 0)));
  EXPECT_T(objEquals(operTokVal, arrayGet_unsafe(operTok, 1)));
  Object eoiTok = queueDeq(tokenQ);
  ASSERT_NE(nullObj.a, eoiTok.a);
  Object eoiTokSym = symbolNew(T_NAMES[T_EOI]);
  EXPECT_T(objEquals(eoiTokSym, arrayGet_unsafe(eoiTok, 0)));
...
void test_lexSpecial() {
  ...
  EXPECT_T(objEquals(specialTokSym, arrayGet_unsafe(specialTok, 0)));
  EXPECT_T(objEquals(specialTokVal, arrayGet_unsafe(specialTok, 1)));
  Object eoiTok = queueDeq(tokenQ);
  ASSERT_NE(nullObj.a, eoiTok.a);
  Object eoiTokSym = symbolNew(T_NAMES[T_EOI]);
  EXPECT_T(objEquals(eoiTokSym, arrayGet_unsafe(eoiTok, 0)));
...
void test_lexBool() {
  ...
  EXPECT_T(objEquals(boolTokSym, arrayGet_unsafe(boolTok, 0)));
  EXPECT_T(objEquals(boolTokVal, arrayGet_unsafe(boolTok, 1)));
  Object eoiTok = queueDeq(tokenQ);
  ASSERT_NE(nullObj.a, eoiTok.a);
  Object eoiTokSym = symbolNew(T_NAMES[T_EOI]);
  EXPECT_T(objEquals(eoiTokSym, arrayGet_unsafe(eoiTok, 0)));
...
void test_lexMultiple() {
  ...
  EXPECT_T(objEquals(tokSym, arrayGet_unsafe(tok, 0)));
  EXPECT_T(objEquals(tokVal, arrayGet_unsafe(tok, 1)));
